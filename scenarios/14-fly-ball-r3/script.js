const scenarios = [
  {
    title: "Fly Ball, R3",
    system: "",
    description: "R3, fly ball to right center, U1 has catch/no catch.",
    runners: "R3",
    outs: "No Outs",
    ball: "Fly ball to right center",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 422 343, 521 197",
    prompt: "Click P's starting position for Scenario 14.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Move to get the best angle to observe R3's tag at 3rd.",
          "Retreat to home.",
        ],
      },
      {
    ...
    paths: [
      {
        ...
        waypoints: [{ x: 387, y: 683 }],
        endAnswer: { x: 419, y: 672 },
      },
      {
        role: "U1",
        startAnswer: { x: 408, y: 510 },
        routePoints: [
          { x: 408, y: 510 },
          { x: 437, y: 517 },
        ],
        waypoints: [],
        endAnswer: { x: 437, y: 517 },
      },
    ],
  },
];
