const scenarios = [
  {
    title: "Fly Ball, R2",
    system: "",
    description: "R2, fly ball to outfield. R2 tags.",
    runners: "R2",
    outs: "No Outs",
    ball: "Fly ball to right center, R2 tags.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 C 470 560, 545 390, 612 314 C 630 294, 642 282, 650 276",
    prompt: "Click P's starting position for Scenario 12.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Stay home and observes the action.",
          "Responsible for R2's touch of 3rd.",
          "Be prepared for a play at the plate.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Move into position to observe R2's tag.",
          "Make the catch/no catch call.",
          "Responsible for all plays in the infield.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 441, y: 691 },
        routePoints: [
          { x: 441, y: 691 },
          { x: 441, y: 698 },
        ],
        waypoints: [],
        endAnswer: { x: 441, y: 698 },
      },
      {
        role: "U1",
        startAnswer: { x: 413, y: 511 },
        routePoints: [
          { x: 413, y: 511 },
          { x: 429, y: 519 },
          { x: 440, y: 504 },
        ],
        waypoints: [{ x: 429, y: 519 }],
        endAnswer: { x: 440, y: 504 },
      },
    ],
  },
];
