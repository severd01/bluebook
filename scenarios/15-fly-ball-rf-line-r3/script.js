const scenarios = [
  {
    title: "Fly Ball RF Line, R3",
    system: "",
    description: "R3, fly ball down right field line, plate has catch/no catch.",
    runners: "R3",
    outs: "No Outs",
    ball: "R3, fly ball right field line.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 492 339, 757 375",
    prompt: "Click P's starting position for Scenario 15.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
