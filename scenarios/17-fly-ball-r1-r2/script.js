const scenarios = [
  {
    title: "Fly Ball, R1,R2",
    system: "",
    description: "R1,R2, fly ball to right field.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Fly ball to right field",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 437 379, 650 276",
    prompt: "Click P's starting position for Scenario 17.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "If fly is not caught, retreat home.",
          "If caught, has play at 3rd if R2 tags.",
          "If play develops at 3rd, move into cutout.",
          "On overthrow retreat to home in fair territory.",
          "If R2 will reach 3rd without any possible play, return home in foul territory.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "If uncaught, you have all plays at all bases.",
          "Make the catch/no catch call.",
          "Glance at R2 and R1's tag ups.",
          "Be in position to react to R2 coming back into 2nd and R1 back into 1st or on to 2nd.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 441, y: 689 },
        routePoints: [
          { x: 441, y: 689 },
          { x: 357, y: 609 },
        ],
        waypoints: [],
        endAnswer: { x: 357, y: 609 },
      },
      {
        role: "U1",
        startAnswer: { x: 407, y: 514 },
        routePoints: [
          { x: 407, y: 514 },
          { x: 434, y: 515 },
        ],
        waypoints: [],
        endAnswer: { x: 434, y: 515 },
      },
    ],
  },
];
