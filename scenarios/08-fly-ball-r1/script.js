const scenarios = [
  {
    title: "Fly Ball, R1",
    system: "",
    description: "R1, fly ball to right field. U1 has catch/no catch.",
    runners: "R1",
    outs: "No Outs",
    ...
    prompt: "Click P's starting position for Scenario 8.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Has all plays on R1 into 3rd.",
      ...
      },
      {
        heading: "U1",
        bullets: [
          "Move to get the best angle possible to observe the catch/no catch.",
          "Do not cross the dirt.",
          "Responsible for all plays at 1st and 2nd.",
          "Glance at the BR's touch of 1st and react to take him back into 1st.",
          "Responsible for tag up on caught fly ball.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 442, y: 687 },
        routePoints: [
          { x: 442, y: 687 },
          { x: 360, y: 614 },
        ],
        waypoints: [],
        endAnswer: { x: 360, y: 614 },
      },
      {
        role: "U1",
        startAnswer: { x: 470, y: 511 },
        routePoints: [
          { x: 470, y: 511 },
          { x: 495, y: 526 },
        ],
        waypoints: [],
        endAnswer: { x: 495, y: 526 },
      },
    ],
  },
];
