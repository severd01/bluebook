const scenarios = [
  {
    title: "Base Hit, R2, R3",
    system: "",
    description: "R2, R3, base hit to left field.",
    runners: "R2, R3",
    outs: "No Outs",
    ball: "Base hit to left field.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 390 360, 306 283",
    prompt: "Click P's starting position for Scenario 25.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Glance at R3's touch of 3rd;",
          "Be ready for possible plays at the plate.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          ...
          "Glance at BR's touch of 1st;",
          "Be alert to take plays at all bases in the infield;",
