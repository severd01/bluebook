const scenarios = [
  {
    title: "Base Hit, possible triple",
    system: "",
    description: "No runners on, hard line drive to left center.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Line drive to left center",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 379 320, 276 146",
    prompt: "Click P's starting position for Scenario 6.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
