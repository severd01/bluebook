const scenarios = [
  {
    title: "Fly Ball RF Line, R1",
    system: "",
    description: "No runners on, fly ball to right field line.",
    runners: "R1",
    outs: "No Outs",
    ball: "Fly ball to right field line.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 500 408, 775 362",
    prompt: "Click P's starting position for Scenario 9.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Clear F2 and move up and straddle the line to rule fair/foul, catch/no catch.",
          "Be stopped when making this call.",
          "Signal fair/foul and then a catch/no catch.",
          "When a catch, tell your partner, \"That's a catch.\"",
          "Observe R1's touch of 3rd.",
          "If no catch, retreat to home.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "If a catch, observe R1's tag and move to rule on any possible plays.",
          "If no catch, observe touch of 2nd and the BR's touch of 1st.",
    ...
    paths: [
      {
        ...
        endAnswer: { x: 464, y: 711 },
      },
      {
        role: "U1",
        startAnswer: { x: 470, y: 514 },
        routePoints: [
          { x: 470, y: 514 },
          { x: 446, y: 519 },
        ],
        waypoints: [],
        endAnswer: { x: 446, y: 519 },
      },
    ],
  },
];
