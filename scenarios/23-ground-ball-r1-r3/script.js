const scenarios = [
  {
    title: "Ground Ball, R1, R3",
    system: "",
    description: "R1,R3 ground ball.",
    runners: "R1, R3",
    outs: "No Outs",
    ball: "Ground Ball",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 L 540 415",
    prompt: "Click P's starting position for Scenario 23.",
    prePitchSignal: {
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Plate stays home.",
          "Observe action to help rule on illegal slides, pulled foot, swipe tags.",
      ...
      },
      {
        heading: "U1",
        bullets: [
          "Move into position to make the call/s, being careful to stay out of the line of a possible throw home.",
          "Watch for runner interference by R1.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [],
        endAnswer: { x: 444, y: 670 },
      },
      {
        role: "U1",
        startAnswer: { x: 470, y: 516 },
        routePoints: [
          { x: 470, y: 516 },
          { x: 488, y: 532 },
        ],
        waypoints: [],
        endAnswer: { x: 488, y: 532 },
      },
    ],
  },
];
