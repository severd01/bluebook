const scenarios = [
  {
    title: "Ground Ball",
    system: "",
    description: "No runners on, ground ball.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Ground ball to short.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 L 339 448",
    prompt: "Click P's starting position for Scenario 7.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Trail the BR up the 1st base line to the 45' line.",
          "Be stopped to observe the pulling of a foot or a swipe tag.",
          "If the ball gets by F3, observe the ball and be sure it does not go into dead ball territory.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Establish a 90 degree angle to the expected throw.",
          "Read the throw and then turn toward the base.",
          "If the play is close, \"sell\" the call.",
          "If there is a tag, say, \"On the tag.\"",
          "If the foot is pulled, give a sweeping motion with both arms and say, \"Off the bag.\"",
          "If the ball gets by F3, move into the infield avoiding the BR.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 441, y: 686 },
        routePoints: [
          { x: 441, y: 686 },
          { x: 427, y: 682 },
          { x: 499, y: 603 },
        ],
        waypoints: [{ x: 427, y: 682 }],
        endAnswer: { x: 499, y: 603 },
      },
      {
        role: "U1",
        startAnswer: { x: 618, y: 523 },
        routePoints: [
          { x: 618, y: 523 },
          { x: 573, y: 500 },
        ],
        waypoints: [],
        endAnswer: { x: 573, y: 500 },
      },
    ],
  },
];
