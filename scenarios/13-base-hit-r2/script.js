const scenarios = [
  {
    title: "Base Hit, R2",
    system: "",
    description: "R2, base hit.",
    runners: "R2",
    outs: "No Outs",
    ball: "R2, base hit to right center.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 473 286, 554 193",
    prompt: "Click P's starting position for Scenario 13.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Observe R2's touch of 3rd.",
          "Move into position for play at the plate.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          ...
          "Move into working area and be prepared to make all calls at all bases.",
        ],
      },
    ],
    paths: [
      ...
      {
        role: "U1",
        startAnswer: { x: 402, y: 517 },
        routePoints: [
          { x: 402, y: 517 },
          { x: 440, y: 521 },
        ],
        waypoints: [],
        endAnswer: { x: 440, y: 521 },
      },
    ],
  },
];
