const scenarios = [
  {
    title: "Fly Ball RF Line, R1,R2",
    system: "",
    description: "R1,R2, fly ball right field line, plate has fair/foul and catch/no catch.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Fly ball to right field line.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 C 454 616, 453 431, 514 376 C 575 321, 759 341, 808 334",
    prompt: "Click P's starting position for Scenario 18.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          ...
          "Responsible for R3's tag at 3rd.",
          "Retreat to home.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Move into working area to observe BR's touch at 1st.",
          "Be in position to react to all plays at any bases.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 467, y: 697 },
      },
      {
        role: "U1",
        startAnswer: { x: 401, y: 522 },
        routePoints: [
          { x: 401, y: 522 },
          { x: 437, y: 521 },
        ],
        waypoints: [],
        endAnswer: { x: 437, y: 521 },
      },
    ],
  },
];
