const scenarios = [
  {
    title: "Base Hit, R1, R3",
    system: "",
    description: "R1,R3, basehit.",
    runners: "R1, R3",
    outs: "No Outs",
    ball: "Base hit to right field.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 520 360, 629 201",
    prompt: "Click P's starting position for Scenario 22.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Move up the line while glancing at R3's touch of home.",
          ...
          "Take all overthrow responsibility (1st and 3rd).",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Look at all touches of 1st and 2nd.",
          "Be ready to make all calls at 1st and 2nd.",
          "Take BR into 3rd on triple.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [],
        endAnswer: { x: 360, y: 617 },
      },
      {
        role: "U1",
        startAnswer: { x: 473, y: 529 },
        routePoints: [
          { x: 473, y: 529 },
          { x: 473, y: 530 },
        ],
        waypoints: [],
        endAnswer: { x: 473, y: 530 },
      },
    ],
  },
];
