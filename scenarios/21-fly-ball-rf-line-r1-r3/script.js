const scenarios = [
  {
    title: "Fly Ball RF Line, R1, R3",
    system: "",
    description: "R1,R3, fly ball to right field line. Plate has fair/foul and catch/no catch.",
    runners: "R1, R3",
    outs: "No Outs",
    ball: "Fly Ball Right Field Line",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 510 380, 737 397",
    prompt: "Click P's starting position for Scenario 21.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
    ...
    paths: [
      {
        ...
        endAnswer: { x: 471, y: 701 },
      },
      {
        role: "U1",
        startAnswer: { x: 475, y: 525 },
        routePoints: [
          { x: 475, y: 525 },
          { x: 445, y: 521 },
        ],
        waypoints: [],
        endAnswer: { x: 445, y: 521 },
      },
    ],
  },
];
