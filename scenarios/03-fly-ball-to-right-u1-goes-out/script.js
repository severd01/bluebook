const scenarios = [
  {
    title: "Fly ball to right, U1 goes out.",
    system: "",
    description: "No runners on, fly ball to right field line.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Fly ball to right field, near foul.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 C 475 560, 610 420, 744 389",
    prompt: "Click P's starting position for Scenario 3.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
