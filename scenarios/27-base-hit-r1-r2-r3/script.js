const scenarios = [
  {
    title: "Base Hit, R1,R2,R3",
    system: "",
    description: "R1, R2, R3, base hit to right center.",
    runners: "R1, R2, R3",
    outs: "No Outs",
    ball: "Base hit to right center.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 C 470 560, 560 380, 523 242",
    prompt: "Click P's starting position for Scenario 27.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Move into position to observe touches of 3rd and home;",
          "Be ready for a play at the plate.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Move into working area;",
          "Has all touches at 1st and 2nd;",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 445, y: 697 },
        routePoints: [
          { x: 445, y: 697 },
          { x: 445, y: 699 },
        ],
        waypoints: [],
        endAnswer: { x: 445, y: 699 },
      },
      {
        role: "U1",
        startAnswer: { x: 406, y: 517 },
        routePoints: [
          { x: 406, y: 517 },
          { x: 441, y: 515 },
        ],
        waypoints: [],
        endAnswer: { x: 441, y: 515 },
      },
    ],
  },
];
