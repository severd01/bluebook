const scenarioTitles = [
  "Routine Fly Ball to Right Field",
  "Routine Fly Ball to left field",
  "Fly ball to right, U1 goes out.",
  "Pop Up On The Infield",
  "Foul Pop Up",
  "Base Hit, possible triple",
  "Ground Ball",
  "Fly Ball, R1",
  "Fly Ball RF Line, R1",
  "Base Hit, R1",
  ...
  "Base Hit, R3",
  "Fly Ball, R1,R2",
  "Fly Ball RF Line, R1,R2",
  "Base Hit, R1,R2",
  "Ground Ball, R1,R2",
  "Fly Ball RF Line, R1, R3",
  "Base Hit, R1, R3",
  "Ground Ball, R1, R3",
  "Fly Ball, R2,R3",
  "Base Hit, R2, R3",
...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Update this scenario description.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Update this situation.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 C 470 560, 545 390, 612 314 C 630 294, 642 282, 650 276",
    prompt: `Click P's starting position for Scenario ${index + 1}.`,
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Update plate guidance for this scenario.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Update U1 guidance for this scenario.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 442, y: 693 },
        routePoints: [
          { x: 442, y: 693 },
          { x: 415, y: 659 },
          { x: 463, y: 602 },
        ],
        waypoints: [{ x: 415, y: 659 }],
        endAnswer: { x: 463, y: 602 },
      },
      {
        role: "U1",
        startAnswer: { x: 604, y: 537 },
        routePoints: [
          { x: 604, y: 537 },
          { x: 500, y: 534 },
          { x: 476, y: 504 },
        ],
        waypoints: [{ x: 500, y: 534 }],
        endAnswer: { x: 476, y: 504 },
      },
    ],
  };
}
