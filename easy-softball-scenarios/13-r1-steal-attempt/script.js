    ...
    answerNotes: [
      {
        ...
        bullets: [
          "When the pitch is delivered, rule it a ball or strike.",
          "Step back and observe the action at home plate, watching for batter interference with F2’s throw.",
          "Adjust your position, if necessary, to observe the play at second base.",
          "Move toward the holding zone if there is an overthrow at second base and be prepared to assist in a rundown or deviate if required to cover the play at third base if the base umpire is unable to.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Move parallel toward second base to obtain an angle 90 degrees to the path of the runner and just short of the base they are trying to reach.",
          "Move as necessary to maintain an unobstructed view of the play.",
          "If there is an overthrow, move inside the diamond and prepare to take R1 to third base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 441, y: 708 },
        routePoints: [
          { x: 441, y: 708 },
          { x: 419, y: 708 },
          { x: 366, y: 657 },
        ],
        waypoints: [{ x: 419, y: 708 }],
        endAnswer: { x: 366, y: 657 },
      },
      {
        role: "U1",
        startAnswer: { x: 532, y: 539 },
        routePoints: [
          { x: 532, y: 539 },
          { x: 481, y: 482 },
        ],
        waypoints: [],
        endAnswer: { x: 481, y: 482 },
      },
    ],
  };
}
