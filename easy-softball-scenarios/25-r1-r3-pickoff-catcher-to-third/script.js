...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, pickoff attempt at third.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Pick Off",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Adjust your position, if necessary, to observe the play at third base being prepared to rule if an overthrow goes near a dead-ball area or there is a play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Depending on the player and how they are covering the play either move parallel toward third base line (player at or in front of the base) or forward toward third base (player coming from behind the base) to obtain an unobstructed view of the play.",
          "Be prepared for a secondary play on R2 attempting to advance to second base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 443, y: 705 },
        routePoints: [
          { x: 443, y: 705 },
          { x: 443, y: 720 },
          { x: 411, y: 697 },
        ],
        waypoints: [{ x: 443, y: 720 }],
        endAnswer: { x: 411, y: 697 },
      },
      {
        role: "U1",
        startAnswer: { x: 352, y: 537 },
        routePoints: [
          { x: 352, y: 537 },
          { x: 322, y: 565 },
        ],
        waypoints: [],
        endAnswer: { x: 322, y: 565 },
      },
    ],
  };
}
