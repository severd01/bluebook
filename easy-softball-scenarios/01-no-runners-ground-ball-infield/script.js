...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "No runners, ground ball to short.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Ground Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Trail the batter-runner no more than one-third of the way to first base in fair territory and read the play. Responsible for any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Step into fair territory, at an angle 90 degrees to the path of the throw, but no more than a 45-degree angle from the foul line and let the ball take you to the play. Responsible for any play at first base, second base or third base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 444, y: 716 },
        routePoints: [
          { x: 444, y: 716 },
          { x: 428, y: 708 },
          { x: 473, y: 661 },
        ],
        waypoints: [{ x: 428, y: 708 }],
        endAnswer: { x: 473, y: 661 },
      },
      {
        role: "U1",
        startAnswer: { x: 582, y: 565 },
        routePoints: [
          { x: 582, y: 565 },
          { x: 561, y: 560 },
          { x: 550, y: 562 },
        ],
        waypoints: [{ x: 561, y: 560 }],
        endAnswer: { x: 550, y: 562 },
      },
    ],
  };
}
