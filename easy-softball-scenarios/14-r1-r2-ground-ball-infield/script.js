...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, ground ball to the infield.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Ground Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Be prepared for a possible double play and move to get the best angle and distance possible being set when the play happens.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [],
        endAnswer: { x: 372, y: 673 },
      },
      {
        role: "U1",
        startAnswer: { x: 358, y: 523 },
        routePoints: [
          { x: 358, y: 523 },
          { x: 445, y: 466 },
        ],
        waypoints: [],
        endAnswer: { x: 445, y: 466 },
      },
    ],
  };
}
