...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 3rd, batter bunts, play at 3rd or 1st.",
    runners: "R1 on 3rd",
    outs: "No Outs",
    ball: "Bunt",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If the ball is fair, signal fair then begin moving toward the holding zone reading the play.",
          "As the play at first base develops, be prepared to offer an opinion on a swipe tag or pulled foot if requested by the base umpire.",
          "Be alert for running lane interference and rule immediately if interference occurs.",
          "If the initial play is at first base be prepared to cover any subsequent play on R1 either at third base or at home plate.",
          "If the first play is on R1 at home plate, position yourself for this play.",
          "Responsible for fair/foul, a subsequent throw to third base on the lead runner (R1) and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Read the play and determine where the play will develop, first base or third base.",
          ...
          "Responsible for the first play in the infield and any play at first base or second base and the last runner (batter-runner) at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 427, y: 704 },
      },
      {
        role: "U1",
        startAnswer: { x: 332, y: 563 },
        routePoints: [
          { x: 332, y: 563 },
          { x: 395, y: 569 },
        ],
        waypoints: [],
        endAnswer: { x: 395, y: 569 },
      },
    ],
  };
}
