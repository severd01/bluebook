...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R2, R3, pickoff attempt at third.",
    runners: "R2, R3",
    outs: "No Outs",
    ball: "Pick Off",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Adjust your position, if necessary, to observe the play at third base while staying prepared for an overthrow near a dead-ball area or a play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Depending on the player covering the play, either move parallel toward the third-base line if the fielder is at or in front of the base, or move forward toward third if the fielder is coming from behind the base, to obtain an unobstructed view of the play.",
          "Be prepared for a secondary play on R2 if they attempt to advance.",
        ],
      },
    ],
    paths: [
