...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 3rd, fly ball to the outfield, ball is caught.",
    runners: "R1 on 3rd",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If there is a live ball appeal of R1 at third base position yourself to make that call.",
          "Responsible for fair/foul, catch/no catch, tag up at third base (R1), any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Continue to alternate between the ball and glancing at the batter-runner keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of the batter-runner.",
        ],
      },
    ],
    paths: [
