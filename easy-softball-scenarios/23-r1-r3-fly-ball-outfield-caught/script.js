...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R3, fly ball to the outfield, ball is caught.",
    runners: "R1, R3",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If there is no play made on R1 at home, remain in the holding zone to watch R1 touch home plate and observe the base umpire bringing R2 to third base.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Continue to alternate between the ball and glancing at R2 keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of R2.",
          "Responsible for any play at first base, second base and the last runner (R2) at third base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 442, y: 714 },
        routePoints: [
          { x: 442, y: 714 },
          { x: 468, y: 693 },
          { x: 382, y: 677 },
        ],
        waypoints: [{ x: 468, y: 693 }],
        endAnswer: { x: 382, y: 677 },
      },
      {
        role: "U1",
        startAnswer: { x: 349, y: 549 },
        routePoints: [
          { x: 349, y: 549 },
          { x: 452, y: 516 },
        ],
        waypoints: [],
        endAnswer: { x: 452, y: 516 },
      },
    ],
  };
}
