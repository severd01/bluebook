...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, base hit to left field.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Base Hit",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as the play develops as you are responsible for any play on a lead runner (R1 or R2) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Pick up the ball and glance at the runner as you hustle inside the diamond about halfway between second base and first base.",
          "Continue to alternate between the ball and glancing at the runners keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of the runner as you are responsible for any play at first base, second base and the last runner (batter-runner) into third base.",
        ],
      },
    ],
    paths: [
