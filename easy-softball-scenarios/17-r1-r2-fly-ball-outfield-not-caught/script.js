...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2 fly ball to right field, ball is not caught.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Responsible for fair/foul, catch/no catch, R1's tag-up at second base, any play on the lead runner (R1 or R2) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for R2's tag-up at first base, any play at first base, second base and the last runner (batter-runner) into third base, or a play on a runner at third base when there is a return throw from the plate area or is cut-off by a player.",
        ],
      },
    ],
    paths: [
