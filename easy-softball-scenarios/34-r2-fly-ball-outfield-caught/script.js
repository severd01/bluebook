...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 2nd, fly ball to the outfield, ball is caught.",
    runners: "R1 on 2nd",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 350 374 454 238",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Once the ball is caught, move toward the holding zone being prepared to cover a rundown at third base if needed.",
          "Once BU is covering the play at third base, move back toward the plate for any play at the plate.",
          "Responsible for fair/foul, catch/no catch and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for R1's tag-up at second base and any play on the last runner (R1) at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 440, y: 727 },
      },
      {
        role: "U1",
        startAnswer: { x: 363, y: 523 },
        routePoints: [
          { x: 363, y: 523 },
          { x: 459, y: 544 },
          { x: 433, y: 545 },
