...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 3rd, ground ball to the infield.",
    runners: "R1 on 3rd",
    outs: "No Outs",
    ball: "Ground Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as the play develops as you are responsible for a subsequent throw to third base on the lead runner (R1) and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for the first throw in the infield (at any base), any play at first base or second base and the last runner (batter-runner) to third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [{ x: 378, y: 662 }],
        endAnswer: { x: 437, y: 725 },
      },
      {
        role: "U1",
        startAnswer: { x: 339, y: 530 },
        routePoints: [
          { x: 339, y: 530 },
          { x: 403, y: 554 },
        ],
        waypoints: [],
        endAnswer: { x: 403, y: 554 },
      },
    ],
  };
}
