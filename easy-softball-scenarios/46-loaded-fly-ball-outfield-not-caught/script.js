...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Bases loaded, fly ball to the outfield, ball is not caught.",
    runners: "R1 on 3rd, R2 on 2nd, R3 on 1st",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 456 390 246 291",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as a play develops. If a play develops as R1 attempts to score, obtain a position at home plate.",
          "If there is no play made on R1 at home, remain in the holding zone to watch R1 touch home plate and be prepared for a play on a lead runner (R2 or R3) at third base or any play at the plate.",
          "Responsible for fair/foul, catch/no catch, the tag-up at third base (R1) any play on a lead runner (R1, R2 or R3) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Position yourself to see R2 and R3 tag-up and the catch.",
          "Continue to alternate between the ball and glancing at the runners keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of R3 if they advance to second base.",
    ...
    paths: [
      {
        ...
        endAnswer: { x: 365, y: 649 },
      },
      {
        role: "U1",
        startAnswer: { x: 335, y: 552 },
        routePoints: [
          { x: 335, y: 552 },
          { x: 469, y: 553 },
        ],
        waypoints: [],
        endAnswer: { x: 469, y: 553 },
      },
    ],
  };
}
