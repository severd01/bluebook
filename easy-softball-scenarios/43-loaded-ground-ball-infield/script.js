...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Bases loaded, ground ball to the infield.",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Move out from behind the plate and read the play.",
          "Be prepared to move as the play develops.",
          "Responsible for a subsequent throw to third base on the lead runner (R1, R2 or R3) and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for the first throw in the infield, any play at first base or second base and the last runner (batter-runner) or a return throw from home plate at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [],
        endAnswer: { x: 352, y: 667 },
      },
      {
        role: "U1",
        startAnswer: { x: 347, y: 546 },
        routePoints: [
          { x: 347, y: 546 },
          { x: 410, y: 550 },
        ],
        waypoints: [],
        endAnswer: { x: 410, y: 550 },
      },
    ],
  };
}
