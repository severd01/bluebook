...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, fly ball to right field, ball is not caught!",
    runners: "R1",
    outs: "No Outs",
    ball: "Fly Ball To Right Field.",
    type: "dual-movement",
    ballFlightPath: "M 441 698 Q 487 452 654 308",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "As the lead runner (R1) approaches second, move toward the holding zone halfway to third in foul ground to an area where you have an unobstructed view of all four elements and read the play.",
          "Be prepared to move as the play develops as you are responsible for fair/foul, catch/no catch, any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 443, y: 708 },
        routePoints: [
          { x: 443, y: 708 },
          { x: 485, y: 645 },
          { x: 382, y: 667 },
        ],
        waypoints: [{ x: 485, y: 645 }],
        endAnswer: { x: 382, y: 667 },
      },
      {
        role: "U1",
        startAnswer: { x: 536, y: 547 },
        routePoints: [
          { x: 536, y: 547 },
          { x: 490, y: 565 },
          { x: 436, y: 523 },
        ],
        waypoints: [{ x: 490, y: 565 }],
        endAnswer: { x: 436, y: 523 },
      },
    ],
  };
}
