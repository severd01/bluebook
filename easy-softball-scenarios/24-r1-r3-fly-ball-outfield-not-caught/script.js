...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, fly ball to the outfield, ball is not caught.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 456 390 276 448",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Move out from behind the plate to get the best angle and distance possible.",
          "Position yourself to observe R1's tag-up at third base as well as the catch.",
          "If the ball is near a foul line, position yourself to observe fair/foul, catch/no catch and R1's tag-up at third base, most likely first baseline or third baseline extended.",
          "After ruling on the catch, move toward the holding zone halfway to third base in foul ground to an area where you have an unobstructed view of all four elements and read the play.",
          "Be prepared to move as a play develops, if R1 attempts to score and a play develops, obtain a position at home plate.",
          "If there is no play made on R1 at home, remain in the holding zone to watch R1 touch home plate and be prepared to cover a play on R2 at third base.",
          "Responsible for fair/foul, catch/no catch, the tag up at third base (R1), any play on the lead runner (R1 or R2) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Pick up the ball and glance at the runner while hustling inside the diamond about halfway between second base and first base.",
          "Position yourself to see R2 tag-up and the possible catch.",
          "Continue to alternate between the ball and glancing at the runners keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of the runners, be prepared for a possible force play at first base or second base or a tag play on the batter-runner at second base.",
          "Responsible for any play at first base, second base and the last runner (batter-runner) at third base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 444, y: 711 },
        routePoints: [
          { x: 444, y: 711 },
          { x: 367, y: 685 },
          { x: 350, y: 600 },
        ],
        waypoints: [{ x: 367, y: 685 }],
        endAnswer: { x: 350, y: 600 },
      },
      {
        role: "U1",
        startAnswer: { x: 330, y: 544 },
        routePoints: [
          { x: 330, y: 544 },
          { x: 450, y: 520 },
        ],
        waypoints: [],
        endAnswer: { x: 450, y: 520 },
      },
    ],
  };
}
...
function goToNextPlayAllScenario() {
  ...
  window.location.href = "../../easy-softball-results.html";
  return true;
}
