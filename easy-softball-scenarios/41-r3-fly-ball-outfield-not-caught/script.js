...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 3rd, fly ball to the outfield, ball is not caught.",
    runners: "R1 on 3rd",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "After ruling no catch, move toward the holding zone halfway to third base in foul ground to an area where you have an unobstructed view of all four elements and read the play.",
          "Be prepared to move as a play develops. If R1 attempts to score and a play develops, obtain a position at home plate.",
          "If there is no play made on R1 at home, remain in the holding zone to watch R1 touch home plate and observe the play.",
          "Responsible for fair/foul, catch/no catch, the tag up at third base (R1), any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Be prepared to move parallel to the baseline staying ahead of the runner, be prepared for a possible force play at first base or a tag play on the batter-runner at second base.",
    ...
    paths: [
      {
        ...
        endAnswer: { x: 441, y: 710 },
      },
      {
        role: "U1",
        startAnswer: { x: 332, y: 542 },
        routePoints: [
          { x: 332, y: 542 },
          { x: 459, y: 562 },
          { x: 449, y: 522 },
        ],
        waypoints: [{ x: 459, y: 562 }],
        endAnswer: { x: 449, y: 522 },
      },
    ],
  };
}
