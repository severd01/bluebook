...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 3rd, R2 on 2nd, batter bunts, play at 1st, 2nd, or 3rd.",
    runners: "R1 on 3rd, R2 on 2nd",
    outs: "No Outs",
    ball: "Bunt",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If the ball is fair, signal fair then begin moving toward the holding zone halfway to third base keeping all elements in your view.",
          "As the play develops, be prepared to offer an opinion on a swipe tag or pulled foot if requested by the base umpire.",
          "Be alert for running lane interference and rule immediately if interference occurs.",
          "If the initial play is at first base or second base, be prepared to cover third base in the event of a subsequent play on R1 or R2 and any play at the plate.",
          "Responsible for fair/foul, a subsequent play on a lead runner (R1 or R2) and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Read the play and determine where the play will develop, first base, second base or third base.",
          "Move to obtain the best angle and distance possible to the play, coming to a set position to allow you to focus on the play.",
          ...
          "Responsible for the first play in the infield and any play at first base, second base and the last runner (batter-runner) at third base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 445, y: 707 },
        routePoints: [
          { x: 445, y: 707 },
          { x: 412, y: 712 },
        ],
        waypoints: [],
        endAnswer: { x: 412, y: 712 },
      },
      {
        role: "U1",
        startAnswer: { x: 335, y: 549 },
        routePoints: [
          { x: 335, y: 549 },
          { x: 356, y: 526 },
        ],
        waypoints: [],
        endAnswer: { x: 356, y: 526 },
      },
    ],
  };
}
