...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Fly ball to right field, ball is caught.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 497 376 647 316",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Move out from behind the plate to get the best angle and distance possible. As the runner approaches second base, move toward the holding zone halfway to third in foul ground to an area where you have an unobstructed view of all four elements and read the play. Responsible for fair/foul, catch/no catch and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Pick up the ball and glance at the runner while hustling inside the diamond to button hook at a minimum depth of 10-12 feet. Continue to alternate between the ball and glancing at the runner keeping all four elements in front of you. Be prepared to move parallel to the baseline staying ahead of the runner. Responsible for any play at first base, second base or third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 475, y: 641 },
      },
      {
        role: "U1",
        startAnswer: { x: 578, y: 566 },
        routePoints: [
          { x: 578, y: 566 },
          { x: 521, y: 587 },
        ],
        waypoints: [],
        endAnswer: { x: 521, y: 587 },
      },
    ],
  };
}
