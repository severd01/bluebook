...
function createScenarioTemplate(title, index) {
  return {
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Responsible for fair/foul, catch/no catch, tag up at third base (R1), any play on a lead runner (R1 or R2) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Be prepared to move parallel to the baseline staying ahead of the runners, be prepared for a possible force play at first base or a tag play on the batter-runner at second base.",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 443, y: 710 },
        routePoints: [
          { x: 443, y: 710 },
          { x: 364, y: 679 },
        ],
        waypoints: [],
        endAnswer: { x: 364, y: 679 },
      },
      {
        role: "U1",
        startAnswer: { x: 343, y: 548 },
        routePoints: [
          { x: 343, y: 548 },
          { x: 456, y: 544 },
          { x: 451, y: 519 },
        ],
        waypoints: [{ x: 456, y: 544 }],
        endAnswer: { x: 451, y: 519 },
      },
    ],
  };
}
