...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Bases loaded, base hit to the outfield.",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as the play develops.",
          "Responsible for any play on the lead runner (R1, R2 or R3) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
    ...
    paths: [
      {
        ...
        waypoints: [],
        endAnswer: { x: 366, y: 670 },
      },
      {
        role: "U1",
        startAnswer: { x: 355, y: 555 },
        routePoints: [
          { x: 355, y: 555 },
          { x: 448, y: 545 },
        ],
        waypoints: [],
        endAnswer: { x: 448, y: 545 },
      },
    ],
  };
}
