...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 2nd, fly ball to the outfield, ball is not caught.",
    runners: "R1 on 2nd",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 456 390 564 266",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Position yourself to call fair/foul, catch/no catch.",
          "After the ball is fair and not caught, move to the holding zone about halfway between third base and home plate.",
          "Be prepared to move into fair territory if a play develops on R1 at third base or to move back home for any play at the plate.",
          "Responsible for fair/foul, catch/no catch, any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for R1's tag-up at second base, and any play at first base, second base and the last runner (batter-runner) at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [{ x: 367, y: 665 }],
        endAnswer: { x: 349, y: 593 },
      },
      {
        role: "U1",
        startAnswer: { x: 364, y: 502 },
        routePoints: [
          { x: 364, y: 502 },
          { x: 469, y: 541 },
        ],
        waypoints: [],
        endAnswer: { x: 469, y: 541 },
      },
    ],
  };
}
