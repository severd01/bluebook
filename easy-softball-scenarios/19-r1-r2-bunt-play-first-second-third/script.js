...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, batter bunts, play at 1st, 2nd, or 3rd.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Bunt",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If the initial play is at first base or second base, be prepared to cover third base in the event of a subsequent play on R1 or any play at the plate.",
          "Responsible for fair/foul and a subsequent play on the lead runner (R1 or R2) at third base.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Read the play and determine where the play will develop at first base, second base or third base.",
          ...
          "Responsible for the first play in the infield, any play at first base, second base and the last runner (batter-runner) at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 348, y: 599 },
      },
      {
        role: "U1",
        startAnswer: { x: 369, y: 515 },
        routePoints: [
          { x: 369, y: 515 },
          { x: 395, y: 479 },
        ],
        waypoints: [],
        endAnswer: { x: 395, y: 479 },
      },
    ],
  };
}
