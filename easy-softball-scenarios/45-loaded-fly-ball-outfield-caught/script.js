...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Bases loaded, fly ball to the outfield, ball is caught.",
    runners: "R1 on 3rd, R2 on 2nd, R3 on 1st",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 456 390 665 315",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If there is no play made on R1 at home, remain in the holding zone to watch R1 touch home plate and be prepared for a play on a lead runner (R2) at third base or any play at the plate.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Responsible for any play at first base, second base and the last runner (R3) at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 372, y: 665 },
      },
      {
        role: "U1",
        startAnswer: { x: 348, y: 549 },
        routePoints: [
          { x: 348, y: 549 },
          { x: 461, y: 552 },
        ],
        waypoints: [],
        endAnswer: { x: 461, y: 552 },
      },
    ],
  };
}
