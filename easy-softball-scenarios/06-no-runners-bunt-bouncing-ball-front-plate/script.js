...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "Bunt up right field line.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Bunt",
    type: "dual-movement",
    ballFlightPath: "M 443 696 L 459 650",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Move as required to view first or third baseline to rule the ball fair or foul as necessary. If the ball is fair, clear the catcher and trail the batter-runner no more than one-third of the P way to first base. Be prepared to rule on a swipe tag up to the running lane. Observe the remainder of the play to offer an opinion of a swipe tag or pulled foot if requested by base umpire. Be alert for running lane interference and rule immediately if interference occurs. Responsible for any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Step into fair territory, in this case at a 45-degree angle from the foul line, and let the ball take you to the play. Responsible for any play at first base, second base or third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 454, y: 672 },
      },
      {
        role: "U1",
        startAnswer: { x: 576, y: 578 },
        routePoints: [
          { x: 576, y: 578 },
          { x: 538, y: 550 },
        ],
        waypoints: [],
        endAnswer: { x: 538, y: 550 },
      },
    ],
  };
}
