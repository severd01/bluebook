...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, fly ball to the outfield, ball is caught.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "After ruling the catch, move toward the holding zone halfway to third base in foul ground to an area where you have an unobstructed view of all four elements and read the play.",
          "Be prepared to move as a play develops, if R1 tags and attempts to score and a play develops, obtain a position at home plate.",
          "If there is no play made on R1 at home, remain in the holding zone to watch R1 touch home plate and be prepared to move back toward the plate when the base umpire brings R2 to third base.",
          "Responsible for fair/foul, catch/no catch, tag up at third base (R1), any play on a lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Position yourself to see R2 tag-up and the catch.",
          "Continue to alternate between the ball and glancing at the runner keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of R2 if they advance to third base.",
          "Responsible for the tag up at second base (R2), any play at second base and the last runner (R2) at third base.",
        ],
      },
    ],
    paths: [
