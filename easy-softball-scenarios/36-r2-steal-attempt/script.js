...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 2nd, steal attempt.",
    runners: "R1 on 2nd",
    outs: "No Outs",
    ball: "Steal Attempt",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Adjust your position, if necessary, to observe the play at third base.",
          "Move toward the holding zone if there is a potential rundown between second base and third base and be prepared to assist in a rundown covering third base.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Move parallel toward third base to obtain an angle 90 degrees to the path of the runner and just short of the base they are trying to reach.",
          "Move as necessary to maintain an unobstructed view of the play.",
          "If a rundown occurs and the plate umpire is there to help, cover second base.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 442, y: 708 },
        routePoints: [
          { x: 442, y: 708 },
          { x: 442, y: 723 },
          { x: 414, y: 712 },
        ],
        waypoints: [{ x: 442, y: 723 }],
        endAnswer: { x: 414, y: 712 },
      },
      {
        role: "U1",
        startAnswer: { x: 381, y: 505 },
        routePoints: [
          { x: 381, y: 505 },
          { x: 331, y: 559 },
        ],
        waypoints: [],
        endAnswer: { x: 331, y: 559 },
      },
    ],
  };
}
