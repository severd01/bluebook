...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 2nd, batter bunts, play at 3rd or 1st.",
    runners: "R1 on 2nd",
    outs: "No Outs",
    ball: "Bunt",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If the initial play is at first base, be prepared to cover third base in the event of a subsequent play on R1 or any play at the plate.",
          "Responsible for fair/foul any subsequent play on a lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for the first throw in the infield, any play at first base or second base and the last runner (batter-runner) at third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 351, y: 593 },
      },
      {
        role: "U1",
        startAnswer: { x: 370, y: 517 },
        routePoints: [
          { x: 370, y: 517 },
          { x: 450, y: 532 },
        ],
        waypoints: [],
        endAnswer: { x: 450, y: 532 },
      },
    ],
  };
}
