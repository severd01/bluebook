...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R3, base hit to the outfield.",
    runners: "R1, R3",
    outs: "No Outs",
    ball: "Base Hit",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If there is no play developing at home, observe R3 touching home plate from the holding zone and be prepared to cover a play on R1 at third base.",
          "Responsible for any play on a lead runner at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 448, y: 718 },
        routePoints: [
          { x: 448, y: 718 },
          { x: 349, y: 650 },
          { x: 356, y: 595 },
        ],
        waypoints: [{ x: 349, y: 650 }],
        endAnswer: { x: 356, y: 595 },
      },
      {
        role: "U1",
