...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, base hit to the outfield.",
    runners: "R1",
    outs: "No Outs",
    ball: "Base Hit",
    type: "dual-movement",
    ballFlightPath: "M 442 696 Q 399 471 291 335",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Trail the batter-runner no more than one-third of the way to first base in fair territory and read the play.",
          "As the lead runner (R1) approaches second base, move toward the holding zone halfway to third in foul ground, unless a play develops at third base.",
          "When a play develops at third base on the lead runner, move toward third base to first obtain the proper angle, then close your distance working to get an unobstructed view of the play and to obtain a final calling distance of 10-12 feet from the play.",
          "Remember, as the four elements come together, stop, read the play and make the call.",
          "Responsible for any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Pick up the ball and glance at the runner while hustling inside the diamond to button hook at a minimum depth of 10-12 feet.",
          "Continue to alternate between the ball and glancing at the runners keeping all four elements in front of you.",
          "Be prepared to move parallel to the baseline staying ahead of the runner.",
          "Responsible for any play at first, second base and the last runner (batter-runner) into third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 387, y: 669 },
      },
      {
        role: "U1",
        startAnswer: { x: 547, y: 542 },
        routePoints: [
          { x: 547, y: 542 },
          { x: 498, y: 573 },
          { x: 462, y: 537 },
        ],
        waypoints: [{ x: 498, y: 573 }],
        endAnswer: { x: 462, y: 537 },
      },
    ],
  };
}
