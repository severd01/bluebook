const scenarioTitles = [
  ...
  "No Runners Fly Ball To Right Field, B Goes Out",
...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "No runners, fly ball to right field, B goes out.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Trouble Fly Ball To Right Field.",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 492 395 599 342",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Trial the batter-runner then move to the best angle and distance (no closer than 18 feet) for a possible play at first base. Be prepared to move parallel with the batter-runner. Responsible for any play made on the batter-runner.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Move parallel to the ball facing the fielder and stop just prior to the fielder making the catch. Watch the play, come to a stop and make an out signal while facing the fielder. Do not turn around and face the diamond to make the signal. Let the ball turn you back toward the infield and observe all playing action. Return to infield when the play is completed. Responsible for fair/foul, catch/no catch.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 437, y: 717 },
        routePoints: [
          { x: 437, y: 717 },
          { x: 425, y: 704 },
          { x: 520, y: 602 },
        ],
        waypoints: [{ x: 425, y: 704 }],
        endAnswer: { x: 520, y: 602 },
      },
      {
        role: "U1",
        startAnswer: { x: 574, y: 571 },
        routePoints: [
          { x: 574, y: 571 },
          { x: 584, y: 455 },
        ],
        waypoints: [],
        endAnswer: { x: 584, y: 455 },
      },
    ],
  };
}
