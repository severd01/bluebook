...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, batter bunts play at 2nd.",
    runners: "R1",
    outs: "No Outs",
    ball: "Bunt",
    type: "dual-movement",
    ballFlightPath: "M 441 695 L 464 662",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "Move as necessary to obtain an unobstructed view of the ball to rule fair or foul.",
          "As the play develops, trail the batter runner no more than one-third of the way to first base.",
          "Be prepared to rule on a swipe tag up to the running lane.",
          "Observe the remainder of the play to offer an opinion of a swipe tag or pulled foot if requested by base umpire.",
          "Be alert for running lane interference and rule immediately if interference occurs.",
          "Be prepared to cover third base in the event of a subsequent play on R1.",
          "If the play is at second base, be prepared to cover third base in the event of a subsequent play on R1.",
          "Responsible for a subsequent play at third base on the lead runner (R1) and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Read the play and determine where the play will develop, first base or second base.",
          "Move to obtain the best angle and distance to the play, coming to a set position to allow you to focus on the play.",
          "For a play at first base, move closer to the first-base line; for a play at second base, move toward second base and stay behind the fielder.",
          "If the play breaks down and there is uncertainty of a swipe tag or pulled foot, make a decision on the play based on the information available.",
          "After the ball is dead consult with the plate umpire if you have a question about an element of the play.",
          "Responsible for any play at first base, second base and the last runner (batter-runner) into third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 357, y: 638 },
      },
      {
        role: "U1",
        startAnswer: { x: 513, y: 515 },
        routePoints: [
          { x: 513, y: 515 },
          { x: 537, y: 542 },
        ],
        waypoints: [],
        endAnswer: { x: 537, y: 542 },
      },
    ],
  };
}
