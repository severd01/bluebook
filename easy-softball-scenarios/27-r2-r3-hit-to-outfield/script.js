...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, base hit to the outfield.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Base Hit",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "If there is no play developing at home, observe R1 touching home plate from the holding zone and be prepared to cover a play on R2 at third base.",
          "Responsible for any play on a lead runner (R1 or R2) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 445, y: 716 },
        routePoints: [
          { x: 445, y: 716 },
          { x: 348, y: 647 },
        ],
        waypoints: [],
        endAnswer: { x: 348, y: 647 },
      },
      {
        role: "U1",
