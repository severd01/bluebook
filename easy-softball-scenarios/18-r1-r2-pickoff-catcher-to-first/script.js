...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2, pickoff attempt at first.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Pick Off",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          "After ruling on the pitch, move to obtain an unobstructed view of the play at first base; observe the play.",
          "If the throw is errant, move as necessary and rule on an overthrow near a dead-ball area.",
          "Be prepared as you are responsible for a subsequent play at third base on R1 and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          "Move to obtain the best angle and distance possible working to obtain 90 degrees to the path of the runner where you can see all four elements of the play.",
          "Come to a set position to observe the play; be prepared to move to a secondary position in case of an overthrow.",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 442, y: 705 },
        routePoints: [
          { x: 442, y: 705 },
          { x: 427, y: 708 },
        ],
        waypoints: [],
        endAnswer: { x: 427, y: 708 },
      },
      {
        role: "U1",
        startAnswer: { x: 365, y: 524 },
        routePoints: [
          { x: 365, y: 524 },
          { x: 397, y: 503 },
        ],
        waypoints: [],
        endAnswer: { x: 397, y: 503 },
      },
    ],
  };
}
