...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, R2 fly ball to right field, ball is caught.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Responsible for fair/foul, catch/no catch, R1's tag-up at second base, any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for R2's tag-up at first base, any play at first base, second base and the last runner (R2) into third base, or a play on a runner at third base when there is a return throw from the plate area or is cut-off by a player.",
        ],
      },
    ],
    paths: [
      {
        ...
        waypoints: [{ x: 411, y: 669 }],
        endAnswer: { x: 349, y: 603 },
      },
      {
        role: "U1",
        startAnswer: { x: 471, y: 548 },
        routePoints: [
          { x: 471, y: 548 },
          { x: 434, y: 523 },
        ],
        waypoints: [],
        endAnswer: { x: 434, y: 523 },
      },
    ],
  };
}
