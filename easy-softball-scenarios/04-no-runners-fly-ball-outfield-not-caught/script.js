...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "No runners on, fly ball to center field, ball is not caught.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ballFlightPath: "M 443 696 Q 328 375 451 245",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 440, y: 714 },
        routePoints: [
          { x: 440, y: 714 },
          { x: 446, y: 623 },
        ],
        waypoints: [],
        endAnswer: { x: 446, y: 623 },
      },
      {
        role: "U1",
