...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, Fly ball to right field, ball is caught.",
    runners: "R1",
    outs: "No Outs",
    ball: "Fly Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as the play develops as you are responsible for fair/foul, catch/no catch and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for R1 tagging up at first base, any play at first base, second base and the last runner (R1) into third base.",
        ],
      },
    ],
    paths: [
      ...
      {
        role: "U1",
        startAnswer: { x: 544, y: 536 },
        routePoints: [
          { x: 544, y: 536 },
          { x: 468, y: 553 },
          { x: 504, y: 592 },
        ],
        waypoints: [{ x: 468, y: 553 }],
        endAnswer: { x: 504, y: 592 },
      },
    ],
  };
}
