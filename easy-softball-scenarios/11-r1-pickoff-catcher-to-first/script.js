...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1, Pickoff attempt.",
    runners: "R1",
    outs: "No Outs",
    ball: "Pick Off",
    type: "dual-movement",
    ...
    answerNotes: [
      ...
      },
      {
        heading: "B",
        bullets: [
          "Move parallel to the baseline and obtain a 90-degree angle to the path of the runner just short of the base they are trying to reach.",
          "Move as necessary to maintain an unobstructed view of the play.",
          "Come to a set position and observe the play.",
          "If there is an overthrow and the ball goes outside move inside the diamond, button hook and be prepared to lead R1 to second base.",
          "If R1 is not retired, observe R1 until the ball is back in the circle or time is called.",
        ],
      },
    ],
    paths: [
      ...
      {
        role: "U1",
        startAnswer: { x: 519, y: 536 },
        routePoints: [
          { x: 519, y: 536 },
          { x: 548, y: 560 },
        ],
        waypoints: [],
        endAnswer: { x: 548, y: 560 },
      },
    ],
  };
}
