...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 2nd, base hit to the outfield.",
    runners: "R1 on 2nd",
    outs: "No Outs",
    ball: "Base Hit",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as the play develops. Responsible for any play on the lead runner (R1) at third base and any play at the plate.",
        ],
      },
      {
        heading: "B",
