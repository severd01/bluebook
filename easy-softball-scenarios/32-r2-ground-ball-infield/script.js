...
function createScenarioTemplate(title, index) {
  return {
    title,
    system: "",
    description: "R1 on 2nd, ground ball to the infield.",
    runners: "R1 on 2nd",
    outs: "No Outs",
    ball: "Ground Ball",
    type: "dual-movement",
    ...
    answerNotes: [
      {
        ...
        bullets: [
          ...
          "Be prepared to move as the play develops as you are responsible for a subsequent throw to third base on R1 and any play at the plate.",
        ],
      },
      {
        heading: "B",
        bullets: [
          ...
          "Responsible for the first throw in the infield, any play at first base or second base and the last runner to third base.",
        ],
      },
    ],
    paths: [
      {
        ...
        endAnswer: { x: 350, y: 595 },
      },
      {
        role: "U1",
        startAnswer: { x: 358, y: 527 },
        routePoints: [
          { x: 358, y: 527 },
          { x: 422, y: 483 },
        ],
        waypoints: [],
        endAnswer: { x: 422, y: 483 },
      },
    ],
  };
}
