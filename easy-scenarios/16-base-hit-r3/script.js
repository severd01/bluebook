const scenarios = [
  {
    title: "Base Hit, R3",
    system: "",
    description: "R3, base hit",
    runners: "R3",
    outs: "No Outs",
    ball: "R3, base hit to left field.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 383 402, 248 305",
    prompt: "Click P's starting position for Scenario 16.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
    ...
    paths: [
      {
        role: "P",
        startAnswer: { x: 441, y: 684 },
        routePoints: [
          { x: 441, y: 684 },
          { x: 441, y: 688 },
        ],
        waypoints: [],
        endAnswer: { x: 441, y: 688 },
      },
      {
        role: "U1",
        startAnswer: { x: 404, y: 522 },
        routePoints: [
          { x: 404, y: 522 },
          { x: 435, y: 519 },
        ],
        waypoints: [],
        endAnswer: { x: 435, y: 519 },
      },
    ],
  },
];
