const scenarios = [
  {
    title: "Routine Fly Ball to left field",
    system: "",
    description: "No runners on, fly to left.",
    runners: "No Runners",
    outs: "No outs",
    ball: "Fly to Left",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 C 410 560, 335 390, 274 336 C 264 330, 258 325, 251 321",
    prompt: "Click P's starting position for Scenario 2.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          ...
          "On a difficult catch/no catch, move as far out as possible.",
          "Obtain the best angle to observe.",
