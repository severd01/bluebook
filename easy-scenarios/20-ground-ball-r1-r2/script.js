const scenarios = [
  {
    title: "Ground Ball, R1,R2",
    system: "",
    description: "R1, R2 ground ball.",
    runners: "R1, R2",
    outs: "No Outs",
    ball: "Ground ball",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 L 528 424",
    prompt: "Click P's starting position for Scenario 20.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
      ...
      },
      {
        heading: "U1",
        bullets: [
          "Move into a position to make a call at any base in the infield being careful to stay out of the line of throw.",
    ...
    paths: [
      ...
      {
        role: "U1",
        startAnswer: { x: 407, y: 521 },
        routePoints: [
          { x: 407, y: 521 },
          { x: 440, y: 523 },
          { x: 457, y: 537 },
        ],
        waypoints: [{ x: 440, y: 523 }],
        endAnswer: { x: 457, y: 537 },
      },
    ],
  },
];
