const scenarios = [
  {
    title: "Pop Up in foul territory",
    system: "",
    description: "No runners on, pop up to the infield.",
    runners: "No Runners",
    outs: "No Outs",
    ball: "Pop up between home and first in foul territory.",
    type: "dual-movement",
    ballFlightPath:
      "M 442 664 Q 470 620, 533 640",
    prompt: "Click P's starting position for Scenario 5.",
    explanation: "",
    answerNotes: [
      {
        heading: "Plate",
        bullets: [
          "Let F2 clear and move into position to rule catch/no catch.",
          "Be aware of the catcher disposing of his mask.",
          "Rule catch/no catch if the player catching the ball is facing you, no matter if it is the F2 or F3.",
        ],
      },
      {
        heading: "U1",
        bullets: [
          "Let F3 clear and move into position to rule catch/no catch.",
          "Rule catch/no catch if the player catching the ball is facing you, no matter if it is the F2 or F3.",
        ],
      },
    ],
    paths: [
      {
        role: "P",
        startAnswer: { x: 444, y: 690 },
        routePoints: [
          { x: 444, y: 690 },
          { x: 451, y: 708 },
          { x: 504, y: 686 },
        ],
        waypoints: [{ x: 451, y: 708 }],
        endAnswer: { x: 504, y: 686 },
      },
      {
        role: "U1",
        startAnswer: { x: 621, y: 510 },
        routePoints: [
          { x: 621, y: 510 },
          { x: 636, y: 517 },
          { x: 576, y: 616 },
        ],
        waypoints: [{ x: 636, y: 517 }],
        endAnswer: { x: 576, y: 616 },
      },
    ],
  },
];
